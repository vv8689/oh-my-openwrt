...
do_build_bin(){
    ...
    if [ $device == "xiaomi" ]; then
        ...
        org_custom_pkgs="-kmod-usb-core -kmod-usb2 -kmod-usb-ohci -kmod-usb-ledtrig-usbport luci-compat luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn libopenssl1.1 ca-certificates wget -dnsmasq dnsmasq-full"
        ...
        org_custom_pkgs="luci-compat luci-lib-ipkg luci-i18n-base-zh-cn luci-i18n-firewall-zh-cn wget ca-certificates ca-bundle -dnsmasq dnsmasq-full"
    fi
